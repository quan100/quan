package com.quan.app.mobile.bff.friendly.feign;
...
import com.quan.app.mobile.bff.friendly.feign.fallback.OpenFriendlyLinkServiceFallback;
 ...
 */
@FeignClient(value = "${quan.app.feign.service.name}", url = "${quan.app.feign.service.url:}", fallbackFactory = OpenFriendlyLinkServiceFallback.class)
