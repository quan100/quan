...
public class TreeUtil {
     ...
     * @return
     */
    public static <T extends com.quan.app.common.util.tree.ITreeNode<T>> List<T> asTreeNodes(List<T> originalDataList) {
     ...
     * @return
     */
    public static <T extends com.quan.app.common.util.tree.ITreeNode<T>> List<T> asTreeNodes(Object parentId, List<T> originalDataList) {
     ...
     * @param <T>
     */
    private static <T extends com.quan.app.common.util.tree.ITreeNode<T>> void buildTreeNode(Object parentId, List<T> originalDataList, List<T> treeNodeData) {
